    ...
    if "message" in update:
        ...
        if text.startswith("/start"):
            ...
            send_message(
                ...
                "Я — твой личный коуч по продажам. За 60 секунд покажу, где ты теряешь клиентов и как это исправить.\n\n"
            ...
            send_message(
                ...
                "Нажми кнопку ниже — получи 7 дней бесплатно и оцени все преимущества.",
                keyboard_inline
            )
        else:
