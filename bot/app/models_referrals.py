        ...
        if "message" in update:
            ...
            if data == "support":
                ...
                if balance_kop < 50000:
                    ...
                    answer_cb(cb["id"], bot_token=bot_token)
                    return
                kb = {"inline_keyboard": [[{"text": "📱 По номеру телефона", "callback_data": "withdraw_method_phone"}], [{"text": "💳 По карте", "callback_data": "withdraw_method_card"}], [{"text": "❌ Отмена", "callback_data
