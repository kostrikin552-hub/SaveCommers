...
analyzeBtn.addEventListener('click', function() {
    ...
    if (!firstAnalysisDone && userId) {
        ...
        // Показываем достижение "Первый анализ"
        ...
        toast.innerHTML = '<strong>🥉 Первый анализ</strong><br><span style="font-size:14px;">Вы сделали первый шаг к улучшению продаж. Продолжайте в том же духе!</span>';
